...
import { LayoutGrid, FileUp, SlidersHorizontal, UserRoundCog } from "lucide-react"
      ...
      <aside className={styles.sidebar} ref={sidebarRef}>
        <nav className={styles.nav}>
          {tabs.map((tab, index) => (
            ...
            >
              {tab === "upload" && <FileUp className={styles.icon} />}
...
// import styles from './Writers.module.css'
// import LiteratureUploader from './textEditor/LiteratureUploader'
...
//   return (
//     <div className={styles.container}>
//         <LiteratureUploader onUpload={handleUpload} />
//     </div>
//   )
// }
